...
export default (state = {}, action) => {
  ...
  switch (action.type) {
    case RECEIVE_PORTFOLIO:
      ...
      Object.values(nextState.stocks).forEach((stock) =>
        !(stock.symbol in action.portfolio.stocks)
          ? delete nextState.stocks[stock.symbol]
          : null
      );
    ...
    case RECEIVE_PORTFOLIOS:
      return merge({}, state, action.portfolios);
