...
//             dollarChange: props.stock.dollarChange,
//             percentageChange: props.stock.percentageChange,
//         }
...
//         if (props.match.params.symbol !== prevProps.match.params.symbol){
//             this.setState({
//                 price: props.stock.price,
//                 dollarChange: props.stock.dollarChange,
//                 percentageChange: props.stock.percentageChange,
...
//             dollarChange: (e.activePayload[0].value - props.stock.chart[0].average).toFixed(2),
//             percentageChange: (((e.activePayload[0].value / props.stock.chart[0].average) - 1 ) * 100).toFixed(2),
//         });
//     }
...
//             </div>
//         )
//         if (Object.keys(portfolios.history).length == 1 && props.location.pathname === "/dashboard") return noStocks
