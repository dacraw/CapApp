            ...
            <main className="splash">
                <section className="splash-main-promo-component">
                    <div>
                        ...
                        <p>CapApp gives you the advantage by making investing simple and effective.</p>
                ...
                <section className="splash-secondary-promo-component">
                    <h1>Retire safely </h1>
                    <p>Aliquam mauris tellus, luctus sed nisi et, tempus molestie eros. Mauris in lacus sed diam blandit pulvinar sit amet vitae libero. Sed tempus dolor non viverra hendrerit.</p>
                    ...
                    <div>
                        ...
                        <div className="three-col">
                            <div>
                                ...
                                <p>Choose how much you want to invest, and lorem ipsum dolar sit amet.</p>
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <p>Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Proin dapibus dignissim nibh, ac aliquam dui.</p>
                            </div>
                        </div>
                        ...
                        <Link to="fractional-shares-disclosure">Fractional Shares Disclosure</Link>
                    </div>
                ...
                <section className="splash-footer-component">
                    <div className="four-col">
                        <ul>
                            <li><Link>Stocks & Funds</Link></li>
                            <li><Link>Options</Link></li>
                            <li><Link>Gold</Link></li>
                            <li><Link>Cash Management</Link></li>
                    ...
                    <ul className="footer-legal-list">
                        <li><Link to="">Check the background of this company using FINRA Broker Check</Link></li>
                        <li><Link to="">CapApp Terms & Conditions</Link></li>
                        <li><Link to="">Disclosure Library</Link></li>
