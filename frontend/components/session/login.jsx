...
class Login extends React.Component {
  ...
  handleSubmit(e) {
    ...
    if (this.props.errors) {
      document.querySelector(".login-invalid-credentials").style.display =
        "none";
    }
  ...
  render() {
    let errors;
    let invalidCredentialCntr = document.querySelector(
    ...
    if (
      this.props.errors &&
      this.props.errors[0].length > 0 &&
      invalidCredentialCntr
    ) {
            ...
            <div className="login-form-holder">
              <form className="session-form" onSubmit={this.handleSubmit}>
                ...
                <div className="input-block">
                  ...
                  <div className="session-error-box login">
                ...
                <ul className="login-invalid-credentials">{errors}</ul>
